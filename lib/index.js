...
const { closeAllServers } = require("./close");
...
function createServer(options, requestListener) {
  ...
  const proxy = new Proxy(server, {
    get(target, name, receiver) {
      ...
      if (name === "listeningOrigin")
        return listeningOrigin(server, serverOptions);
  ...
  function close(callback) {
    ...
    closeAllServers(proxy, serverOptions.forceCloseConnections, cb);
